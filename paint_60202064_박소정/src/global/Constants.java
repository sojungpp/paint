...
public class Constants {
	...
	public enum ETools {
		...
		eRoundRectangle("둥근네모", new TRoundRectangle(), "images/roundRectangle.png", ETransformationStyle.e2PTransformation, "네모를 그립니다."),
		...
		eCurve("곡선", new TCurve(), "images/curve.png", ETransformationStyle.e2PTransformation, "곡선을 그립니다.");
		//
